...
public class EditManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jTabbedPaneEditClient, javax.swing.GroupLayout.PREFERRED_SIZE, 1044, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jButtonOpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOpenActionPerformed
        ...
        jTextFieldCPF.setText(values[0]);
        jTextFieldGym.setText(values[13]);
        //jTextFieldSalary.setText(5000);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        String filePath = "C:\\Users\\auxlu\\OneDrive\\Documentos\\NetBeansProjects\\ClientManagment\\src\\Resources\\managers.txt";
        ...
        String trainerInfo = String.format("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n",
                CPF, username, firstName, lastName, email, password, phoneNumber, birthDate, gender,
                city, state, country, salary, gym);

        //controller.setArchive("update");
        //String fileContent = "";
        //if (controller.read()) {
         //   fileContent = controller.getText();
        //}

        //fileContent += trainerInfo;
    ...
    String filePath = "C:\\Users\\auxlu\\OneDrive\\Documentos\\NetBeansProjects\\ClientManagment\\src\\Resources\\managers.txt"; // replace with your file path
